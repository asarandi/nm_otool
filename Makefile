...
NM_FILES	= main.c
OTOOL		= ft_otool
OTOOL_FILES	= main.c otool_print.c section.c
SHAREDFILES	= archive.c extras.c fat.c fat_cpu.c fat_file.c getters.c helpers.c is.c loader.c messages.c print.c sizeof.c swap.c swapx.c sym_array.c symbol.c validate.c
LIBFT		= libft/libft.a
SRC_DIR		= src/
OBJ_DIR		= obj/
